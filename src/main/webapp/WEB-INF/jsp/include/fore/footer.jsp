...
<div id="footer"  class="footer" style="display: block;">
	...
	<div id="footer_desc" class="footer_desc">
		...
		<div class="descColumn">
			<span class="descColumnTitle">爱购保障</span>
		...
		<div class="descColumn">
			...
			<a href="#nowhere" >爱购智库</a>
			<a href="#nowhere" >爱购规则</a>
			<a href="#nowhere" >物流服务</a>
			<a href="#nowhere" >运营服务</a>
		</div>
		<div class="descColumn">
			<span class="descColumnTitle">手机爱购</span>
	...
	<div id="copyright" class="copyright">
		...
		<%--	<img id="cateye" class="cateye" src="img/site/cateye.png">--%>
			<div class="white_link" >
				<a href="#nowhere" style="padding-left:0px" >关于爱购</a>
			...
			<div class="white_link" >
				<a href="#nowhere" > 爱购网</a><span class="slash">|</span>
